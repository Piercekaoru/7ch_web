...
const resources = {
      'zh-CN': {
            translation: {
                  ...
                  "commonLinks.cobalt.featurePasteTitle": "粘贴链接即可保存",
                  "commonLinks.cobalt.featurePasteBody": "官方定位就是“把链接贴进去就能拿到内容”，适合临时保存公开视频、音频或图片。",
                  "commonLinks.cobalt.featureCleanTitle": "不靠广告和追踪器堆体验",
                  "commonLinks.cobalt.featureCleanBody": "官方强调它不是那类充满广告、跟踪器和付费墙的下载站，而是偏公共工具的路线。",
                  "commonLinks.cobalt.featurePrivacyTitle": "处理方式更克制",
                  "commonLinks.cobalt.featurePrivacyBody": "官方介绍里明确提到尽量减少日志留存，并避免把用户行为变成可售卖的数据。",
...
A: 互联网不是法外之地。虽然本站承诺不建立用户画像，但互联网的基础设施（ISP、电信运营商）依然有迹可循。如果您的言论涉及严重犯罪，执法机构仍可能通过技术手段定位到您。我们不对用户的言论负责，但在法律强制要求下，我们会配合提供仅有的服务器日志信息（如临时 ID 记录）。`,
      ...
      'ja-JP': {
            translation: {
                  ...
                  "commonLinks.cobalt.featurePasteTitle": "リンクを貼るだけで使える",
                  "commonLinks.cobalt.featurePasteBody": "公式の説明どおり、まずはリンクを貼り付けて保存するための道具で、公開メディアを手早く扱いたい時に向いています。",
                  "commonLinks.cobalt.featureCleanTitle": "広告まみれの路線ではない",
                  "commonLinks.cobalt.featureCleanBody": "公式は、広告やトラッカーや課金壁だらけのダウンロードサイトではなく、公共性のある道具として運営する姿勢を打ち出しています。",
                  "commonLinks.cobalt.featurePrivacyTitle": "扱い方が比較的慎重",
                  "commonLinks.cobalt.featurePrivacyBody": "公式説明では、ログの持ちすぎを避け、利用者の行動を売り物にしない設計思想が強調されています。",
